...
class DummysRepository {
  static List<MovieResponse> movieResponses;
  static MoviesResponse moviesResponse;
  static List<CommentsResponse> commentsResponses;
  ...
  static MoviesResponse loadMovies(int orderType) {
    moviesResponse = MoviesResponse(orderType: 0, movies: [
      Movie(
          '신과함께-죄와벌',
          7.98,
          12,
